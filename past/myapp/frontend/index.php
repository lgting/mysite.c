...
<head>
    ...
    <body>
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active">
                                    <a href="index.html" class="nav-link">Updates</a>
                                </li>
                                 <li class="nav-item">
                                    <a href="mystudy.html" class="nav-link">My Study</a>
                                </li>
                                <li class="nav-item">
                                    <a href="literature.html" class="nav-link">Literature</a>
                                </li>
                                <li class="nav-item">
      ...
      <div class="" align="center">
           <img src="img/tm-home-img.jpg" alt="Image" class=" img-fluid">
       </div>
